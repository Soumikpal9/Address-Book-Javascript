...
addressBookArr.sort((contact1, contact2) => (contact1.firstName).localeCompare(contact2.firstName))
console.log(addressBookArr)
addressBookArr.sort((contact1, contact2) => (contact1.city).localeCompare(contact2.city))
console.log(addressBookArr)
addressBookArr.sort((contact1, contact2) => (contact1.state).localeCompare(contact2.state))
console.log(addressBookArr)
addressBookArr.sort((contact1, contact2) => (contact1.zipcode).localeCompare(contact2.zipcode))
console.log(addressBookArr)